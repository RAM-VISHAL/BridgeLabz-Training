...
public static String lowerToUpper(String str){
  ...
  public static boolean  compareString(String s1, String s2){
   ...
   //Build in method 
    String buildInResult = str.toUpperCase();
    
   // manual method
    String userBuildInResult = lowerToUpper(str);
    
    System.out.println("User Define upperCase :"+userBuildInResult);
     System.out.println(" build-In upperCase :"+buildInResult);
